...
import com.vajraraksha.service.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/register", "/login", "/css/**", "/js/**", "/images/**", "/WEB-INF/**")
                        .permitAll()
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        DaoAuthenticationProvider authProvider = new DaoAuthenticationProvider(userDetailsService); // Use constructor
