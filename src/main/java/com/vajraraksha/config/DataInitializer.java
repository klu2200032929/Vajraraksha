...
public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                if (courseRepository.count() == 0) {
                        ...
                        netCourse.setDescription(
                                        "Master the art of packet analysis, port scanning, and firewall configuration.");
                        netCourse.setInstructorId("admin");
                        ...
                        netQuiz.getQuestions()
                                        .add(new com.vajraraksha.model.Question(
                                                        "Which protocol is connection-oriented?",
                                                        java.util.Arrays.asList("UDP", "TCP", "ICMP", "IP"), 1,
                        ...
                        webCourse.setDescription(
                                        "Learn to exploit and patch OWASP Top 10 vulnerabilities like SQLi and XSS.");
                        webCourse.setInstructorId("admin");

                        webCourse.getLessons().add(new com.vajraraksha.model.Lesson("SQL Injection 101",
                                        "How attackers steal data via input fields.",
                                        "https://www.youtube.com/embed/_jKylhJtGsM"));
                        ...
                        cryptoCourse.setInstructorId("admin");
                ...
                if (labRepository.count() == 0) {
                        ...
                        lab1.setInstructorId("admin");
                        lab1.setPoints(200);
                        lab1.setSteps(new java.util.ArrayList<>());

                        lab1.getSteps().add(new com.vajraraksha.model.LabStep(1, "Verify Tool Installation",
                                        "nmap --version",
                                        "Nmap version 7.92 ( https://nmap.org )",
                                        "Always check your tools before engagement."));
                        ...
                        lab1.getSteps().add(
                                        new com.vajraraksha.model.LabStep(3, "Service Detection", "nmap -sV 10.10.5.55",
                        ...
                        lab2.getSteps()
                                        .add(new com.vajraraksha.model.LabStep(1, "Test Vulnerability",
                                                        ...
                                                        "Automated testing for SQLi flaws."));
